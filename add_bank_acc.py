...
# Form implementation generated from reading ui file 'add_bank_acc.ui'
#
...
"}")
        ...
        self.label116 = QtWidgets.QLabel(self.page_home)
        self.label116.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        ...
        self.label_162 = QtWidgets.QLabel(self.page_home)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout.addWidget(self.label_162, 1, 0, 1, 1)
        self.lineEdit16 = QtWidgets.QLineEdit(self.page_home)
        self.lineEdit16.setMinimumSize(QtCore.QSize(0, 30))
        self.lineEdit16.setObjectName("lineEdit16")
        self.gridLayout.addWidget(self.lineEdit16, 1, 1, 1, 1)
        self.textEdit16 = QtWidgets.QTextEdit(self.page_home)
        self.textEdit16.setMaximumSize(QtCore.QSize(16777215, 100))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.textEdit16.setFont(font)
        self.textEdit16.setObjectName("textEdit16")
        self.gridLayout.addWidget(self.textEdit16, 2, 1, 1, 1)
        self.label16 = QtWidgets.QLabel(self.page_home)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout.addWidget(self.label16, 0, 0, 1, 1)
        self.lineEdit_162 = QtWidgets.QLineEdit(self.page_home)
        self.lineEdit_162.setMinimumSize(QtCore.QSize(0, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEdit_162.setFont(font)
        self.lineEdit_162.setObjectName("lineEdit_162")
        self.gridLayout.addWidget(self.lineEdit_162, 0, 1, 1, 1)
        self.verticalLayout_6.addLayout(self.gridLayout)
        self.verticalLayout_10.addLayout(self.verticalLayout_6)
        self.pushButton16 = QtWidgets.QPushButton(self.page_home)
        self.pushButton16.setMinimumSize(QtCore.QSize(0, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.verticalLayout_10.addWidget(self.pushButton16)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label116.setText(_translate("MainWindow", "Add Bank Account"))
        self.label_163.setText(_translate("MainWindow", "Bank Details"))
        self.label_162.setText(_translate("MainWindow", "Bank name & Branch"))
        self.label16.setText(_translate("MainWindow", "Bank name (in application)"))
        self.lineEdit_162.setText(_translate("MainWindow", "This name would be displayed for further references"))
        self.pushButton16.setText(_translate("MainWindow", "Add Account"))
